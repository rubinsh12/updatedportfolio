/*! * Item: Kitzu * Description: Personal Portfolio Template * Author/Developer: Exill * Author/Developer URL: https://themeforest.net/user/exill * Version: v2.0.0 * License: Themeforest Standard Licenses: https://themeforest.net/licenses */
!function(e){
    "use strict";
    e((function(){
        function t(t,i){
        ...
        (),e(".home-area").hasClass("video-variant")&&e("#homeVideo").YTPlayer(),t("#about .testimonials-section",(function(){
            tns({
                container:"#about .testimonials-section .my-slider",items:2,gutter:30,responsive:{
                    0:{
                        items:1,gutter:0
                    }
                    ,768:{
                ...
                ,preventScrollOnTouch:"auto",slideBy:"page",mouseDrag:!0,swipeAngle:!1,speed:400,controls:!1,autoHeight:!0,navPosition:"bottom"
            }
            )
        }
            ...
            var t=function(){
                e("#resume .skills-section .single-skill").each((function(){
                    var t=Math.min(100,Math.max(0,e(this).data("percentage"))),i=e(this).find(".skill-progress").outerWidth(!0),a=i-i*(t/100);
            ...
            t.imagesLoaded((function(){
                t.isotope({
                    itemSelector:"#portfolio .portfolio-section .single-item",masonry:{
                        horizontalOrder:!0
                    }
                }
                ),i.on("click",(function(){
                    ...
                    t.isotope({
                        filter:a,transitionDuration:".25s"
                    }
                    )
                }
                ))
            ...
            e("#contact .contact-section .contact-form").on("submit",(function(t){
                ...
                t.preventDefault(),a.html("Wait...").addClass("wait").prop("disabled",!0),setTimeout((function(){
                    e.ajax({
                        url:i.attr("action"),type:"POST",data:i.serialize()
                    }
                    ).done((function(e){
