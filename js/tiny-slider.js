var tns=function(){
    ...
    var t=window,e=t.requestAnimationFrame||t.webkitRequestAnimationFrame||t.mozRequestAnimationFrame||t.msRequestAnimationFrame||function(t){
        return setTimeout(t,16)
    }
    ,n=window,i=n.cancelAnimationFrame||n.mozCancelAnimationFrame||function(t){
        clearTimeout(t)
    }
    ;
    function a(){
    ...
    var p="classList"in document.createElement("_"),h=p?function(t,e){
    ...
    function C(t,e){
        if(t=b(t)||t instanceof Array?t:[t],"[object Object]"===Object.prototype.toString.call(e))for(var n=t.length;
        n--;
    ...
    function A(t){
        ...
        for(var i=document.createElement("fakeelement"),a=(t.length,0);
        a<t.length;
        a++){
            var r=t[a];
    ...
    var R=function(t){
        t=a({
            container:".slider",mode:"carousel",axis:"horizontal",items:1,gutter:0,edgePadding:0,fixedWidth:!1,autoWidth:!1,viewportMax:!1,slideBy:1,center:!1,controls:!0,controlsPosition:"top",controlsText:["prev","next"],controlsContainer:!1,prevButton:!1,nextButton:!1,nav:!0,navPosition:"top",navContainer:!1,navAsThumbnails:!1,arrowKeys:!1,speed:300,autoplay:!1,autoplayPosition:"top",autoplayTimeout:5e3,autoplayDirection:"forward",autoplayText:["start","stop"],autoplayHoverPause:!1,autoplayButton:!1,autoplayButtonOutput:!0,autoplayResetOnVisibility:!0,animateIn:"tns-fadeIn",animateOut:"tns-fadeOut",animateNormal:"tns-normal",animateDelay:!1,loop:!0,rewind:!1,autoHeight:!1,responsive:!1,lazyload:!1,lazyloadSelector:".tns-lazy-img",touch:!0,mouseDrag:!1,swipeAngle:15,nested:!1,preventActionWhenRunning:!1,preventScrollOnTouch:!1,freezable:!0,onInit:!1,useLocalStorage:!0
        }
        ,t||{
        }
        );
        var n=document,l=window,p={
        ...
        ,B=t.useLocalStorage;
        if(B){
            var S=navigator.userAgent,O=new Date;
            try{
        ...
        var I,P,z,W,F,q,j,V=b.tC?r(b.tC):o(b,"tC",function(){
            var t=document,e=u(),n=s(e),i=t.createElement("div"),a=!1;
            e.appendChild(i);
            try{
                for(var r,o="(10px * 10)",l=["calc"+o,"-moz-calc"+o,"-webkit-calc"+o],f=0;
                f<3;
                f++)if(r=l[f],i.style.width=r,100===i.offsetWidth){
                    a=r.replace(o,"");
                    break
                }
            }
        ...
        if(et.forEach((function(e){
            if("string"==typeof t[e]){
                var i=t[e],a=n.querySelector(i);
                if(nt[e]=i,!a||!a.nodeName)return void(tt&&console.warn("Can't find",t[e]));
                t[e]=a
            }
        }
        )),!(t.container.children.length<1)){
            var it=t.responsive,at=t.nested,rt="carousel"===t.mode;
            if(it){
            ...
            (t),!rt){
                ...
                var st=t.animateIn,ct=t.animateOut,ft=t.animateDelay,dt=t.animateNormal
            }
            ...
            var Et,Nt,At,Lt,Bt,St,Ot,Dt=t.autoWidth,Ht=Fn("fixedWidth"),kt=Fn("edgePadding"),Rt=Fn("gutter"),It=zn(),Pt=Fn("center"),zt=Dt?1:Math.floor(Fn("items")),Wt=Fn("slideBy"),Ft=t.viewportMax||t.fixedWidthViewportWidth,qt=Fn("arrowKeys"),jt=Fn("speed"),Vt=t.rewind,Gt=!Vt&&t.loop,Qt=Fn("autoHeight"),Xt=Fn("controls"),Yt=Fn("controlsText"),Kt=Fn("nav"),Jt=Fn("touch"),Ut=Fn("mouseDrag"),_t=Fn("autoplay"),Zt=Fn("autoplayTimeout"),$t=Fn("autoplayText"),te=Fn("autoplayHoverPause"),ee=Fn("autoplayResetOnVisibility"),ne=(Ot=document.createElement("style"),document.querySelector("head").appendChild(Ot),Ot.sheet?Ot.sheet:Ot.styleSheet),ie=t.lazyload,ae=(t.lazyloadSelector,[]),re=Gt?(Bt=function(){
                if(Dt||Ht&&!Ft)return wt-1;
                var e=Ht?"fixedWidth":"items",n=[];
                if((Ht||t[e]<wt)&&n.push(t[e]),it)for(var i in it){
                    var a=it[i][e];
                    a&&(Ht||a<wt)&&n.push(a)
                }
                return n.length||n.push(0),Math.ceil(Ht?Ft/Math.min.apply(null,n):Math.max.apply(null,n))
            }
            (),St=rt?Math.ceil((5*Bt-wt)/2):4*Bt-wt,St=Math.max(Bt,St),Wn("edgePadding")?St+1:St):0,oe=rt?wt+2*re:wt+re,ue=!(!Ht&&!Dt||Gt),le=Ht?Bi():null,se=!rt||!Gt,ce=ht?"left":"top",fe="",de="",ve=Ht?function(){
            ...
            ,pe=Hn(Fn("startIndex")),he=pe,me=(Dn(),0),ye=Dt?null:ve(),ge=t.preventActionWhenRunning,xe=t.swipeAngle,be=!xe||"?",Ce=!1,we=t.onInit,Me=new k,Te=" tns-slider tns-"+t.mode,Ee=gt.id||(Lt=window.tnsId,window.tnsId=Lt?Lt+1:1,"tns"+window.tnsId),Ne=Fn("disable"),Ae=!1,Le=t.freezable,Be=!(!Le||Dt)&&ei(),Se=!1,Oe={
                click:zi,keydown:function(t){
                    t=Xi(t);
            ...
            ,De={
                click:function(t){
                    ...
                    if(g(e,"data-nav")){
                        var n=ln=Number(x(e,"data-nav")),i=Ht||Dt?n*wt/on:n*zt;
                ...
                ,keydown:function(t){
                    ...
                    if(g(e,"data-nav")){
                        var i=[p.LEFT,p.RIGHT,p.ENTER,p.SPACE].indexOf(t.keyCode),a=Number(x(e,"data-nav"));
            ...
            ,Ie={
                touchstart:_i,touchmove:Zi,touchend:$i,touchcancel:$i
            }
            ,Pe={
                mousedown:_i,mousemove:Zi,mouseup:$i,mouseleave:$i
            }
            ...
            if(ze)var Ke,Je,Ue=t.controlsContainer,_e=t.controlsContainer?t.controlsContainer.outerHTML:"",Ze=t.prevButton,$e=t.nextButton,tn=t.prevButton?t.prevButton.outerHTML:"",en=t.nextButton?t.nextButton.outerHTML:"";if(We)var nn,an=t.navContainer,rn=t.navContainer?t.navContainer.outerHTML:"",on=Dt?wt:ea(),un=0,ln=-1,sn=Rn(),cn=sn,fn="tns-nav-active",dn="Carousel Page ",vn=" (Current Slide)";
            if(qe)var pn,hn,mn,yn,gn,xn="forward"===t.autoplayDirection?1:-1,bn=t.autoplayButton,Cn=t.autoplayButton?t.autoplayButton.outerHTML:"",wn=["<span class='tns-visually-hidden'>"," animation</span>"];
            if(je||Ve)var Mn,Tn,En={
            }
            ,Nn={
            }
            ,An=!1,Ln=ht?function(t,e){
                return t.x-e.x
            }
            :function(t,e){
                return t.y-e.y
            ...
            ;
            Dt||On(Ne||Be),X&&(ce=X,fe="translate",Y?(fe+=ht?"3d(":"3d(0px, ",de=ht?", 0px, 0px)":", 0px)"):(fe+=ht?"X(":"Y(",de=")")),rt&&(gt.className=gt.className.replace("tns-vpfix","")),function(){
                ...
                if(xt.insertBefore(mt,gt),yt.appendChild(gt),v(Ct,(function(t,e){
                    ...
                    for(var e=n.createDocumentFragment(),i=n.createDocumentFragment(),a=re;
                    a--;
                    ){
                        var r=a%wt,o=Ct[r].cloneNode(!0);
            ...
            (),function(){
                if(!rt)for(var e=pe,n=pe+Math.min(wt,zt);
                e<n;
                e++){
                    var i=Ct[e];
                ...
                if(it&&Q)for(var r in it){
                    r=parseInt(r);
                    var o=it[r],u=(a="",""),s="",c="",p="",h=Dt?null:Fn("items",r),g=Fn("fixedWidth",r),x=Fn("speed",r),b=Fn("edgePadding",r),C=Fn("autoHeight",r),w=Fn("gutter",r);
            ...
            ;
            return{
                version:"2.9.2",getInfo:ia,events:Me,goTo:Pi,play:function(){
                    _t&&!hn&&(ji(),yn=!1)
                }
                ,pause:function(){
                    hn&&(Vi(),yn=!0)
                }
                ,isOn:Tt,updateSliderHeight:xi,refresh:Kn,destroy:function(){
                    ...
                    for(var a in et.forEach((function(e,n){
                        ...
                        if("object"==typeof a){
                            var r=!!a.previousElementSibling&&a.previousElementSibling,o=a.parentNode;
        ...
        function _n(){
            ...
            if(We){
                if(an)C(an,{
                    ...
                    C(t,{
                        "data-nav":e,tabindex:"-1","aria-label":dn+(e+1),"aria-controls":Ee
                    }
                    )
                }
                ));
                else{
                    for(var n="",i=Fe?"":'style="display:none"',a=0;
                    a<wt;
                    a++)n+='<button data-nav="'+a+'" tabindex="-1" aria-controls="'+Ee+'" '+i+' aria-label="'+dn+(a+1)+'"></button>';
                ...
                if(na(),K){
                    var r=K.substring(0,K.length-18).toLowerCase(),o="transition: all "+jt/1e3+"s";
        ...
        function ti(e){
            if(Tt){
                ...
                if(qt=Fn("arrowKeys"),Xt=Fn("controls"),Kt=Fn("nav"),Jt=Fn("touch"),Pt=Fn("center"),Ut=Fn("mouseDrag"),_t=Fn("autoplay"),te=Fn("autoplayHoverPause"),ee=Fn("autoplayResetOnVisibility"),i&&(Ne=Fn("disable"),Ht=Fn("fixedWidth"),jt=Fn("speed"),Qt=Fn("autoHeight"),Yt=Fn("controlsText"),$t=Fn("autoplayText"),Zt=Fn("autoplayTimeout"),Q||(kt=Fn("edgePadding"),Rt=Fn("gutter"))),On(Ne),It=zn(),ht&&!Dt||Ne||(bi(),ht||(ta(),r=!0)),(Ht||Dt)&&(le=Bi(),ye=ve()),(i||Ht)&&(zt=Fn("items"),Wt=Fn("slideBy"),(u=zt!==c)&&(Ht||Dt||(ye=ve()),Bn())),i&&Ne!==p&&(Ne?oi():function(){
                    if(Ae){
                        if(ne.disabled=!1,gt.className+=Te,Oi(),Gt)for(var t=re;
                        t--;
                        )rt&&E(Ct[t]),E(Ct[oe-t-1]);
                        if(!rt)for(var e=pe,n=pe+wt;
                        e<n;
                        e++){
                            var i=Ct[e],a=e<pe+zt?st:dt;
                ...
                ()),Le&&(i||Ht||Dt)&&(Be=ei())!==h&&(Be?(Di(Si(Hn(0))),ri()):(function(){
                    if(Se){
                        if(kt&&Q&&(yt.style.margin=""),re)for(var t="tns-transparent",e=re;
                        e--;
                ...
                (),r=!0)),On(Ne||Be),_t||(te=ee=!1),qt!==g&&(qt?D(n,Re):H(n,Re)),Xt!==x&&(Xt?Ue?E(Ue):(Ze&&E(Ze),$e&&E($e)):Ue?T(Ue):(Ze&&T(Ze),$e&&T($e))),Kt!==b&&(Kt?E(an):T(an)),Jt!==C&&(Jt?D(gt,Ie,t.preventScrollOnTouch):H(gt,Ie)),Ut!==w&&(Ut?D(gt,Pe):H(gt,Pe)),_t!==M&&(_t?(bn&&E(bn),hn||yn||ji()):(bn&&T(bn),hn&&Vi())),te!==N&&(te?D(gt,He):H(gt,He)),ee!==A&&(ee?D(n,ke):H(n,ke)),i){
                    if(Ht===B&&Pt===k||(r=!0),Qt!==S&&(Qt||(yt.style.height="")),Xt&&Yt!==O&&(Ze.innerHTML=Yt[0],$e.innerHTML=Yt[1]),bn&&$t!==R){
                        var z=_t?1:0,W=bn.innerHTML,F=W.length-R[z].length;
                ...
                if((u||Ht&&!Dt)&&(on=ea(),na()),(o=pe!==L)?(Me.emit("indexChanged",ia()),r=!0):u?o||mi():(Ht||Dt)&&(ci(),Ci(),ui()),u&&!rt&&function(){
                    for(var t=pe+Math.min(wt,zt),e=oe;
                    e--;
                    ){
                        var n=Ct[e];
        ...
        function ei(){
            ...
            var t=Ht?(Ht+Rt)*wt:Et[wt],e=kt?It+2*kt:It+Rt;
        ...
        function ri(){
            if(!Se){
                if(kt&&(yt.style.margin="0px"),re)for(var t="tns-transparent",e=re;
                e--;
        ...
        function oi(){
            if(!Ae){
                if(ne.disabled=!0,gt.className=gt.className.replace(Te.substring(1),""),w(gt,["style"]),Gt)for(var t=re;
                t--;
                )rt&&T(Ct[t]),T(Ct[oe-t-1]);
                if(ht&&rt||w(yt,["style"]),!rt)for(var e=pe,n=pe+wt;
                e<n;
                e++){
                    var i=Ct[e];
        ...
        function mi(){
            ci(),Ci(),ui(),Ni(),function(){
                if(Kt&&(sn=0<=ln?ln:Rn(),ln=-1,sn!==cn)){
                    var t=nn[cn],e=nn[sn];
                    C(t,{
                        tabindex:"-1","aria-label":dn+(cn+1)
                    }
                    ),y(t,fn),C(e,{
                        "aria-label":dn+(sn+1)+vn
                    }
        ...
        function gi(t,e){
            for(var n=[],i=t,a=Math.min(t+e,oe);
            i<a;
            i++)n.push(Ct[i].offsetHeight);
            return Math.max.apply(null,n)
        }
        function xi(){
            var t=Qt?gi(pe,zt):gi(re,wt),e=vt||yt;
            e.style.height!==t&&(e.style.height=t+"px")
        }
        function bi(){
            Et=[0];
            var t=ht?"left":"top",e=ht?"right":"bottom",n=Ct[0].getBoundingClientRect()[t];
            v(Ct,(function(i,a){
        ...
        function Ni(){
            if(Xt&&!Vt&&!Gt){
                var t=Ke?Ze.disabled:Ti(Ze),e=Je?$e.disabled:Ti($e),n=pe<=me,i=!Vt&&ye<=pe;
        ...
        function Si(t){
            var e;
            if(null==t&&(t=pe),ht&&!Dt)if(Ht)e=-(Ht+Rt)*t,Pt&&(e+=Li());
            else{
                var n=X?oe:zt;
                Pt&&(t-=Li()),e=100*-t/n
            }
        ...
        function Ii(t){
            if(rt||Ce){
                if(Me.emit("transitionEnd",ia(t)),!rt&&0<ae.length)for(var e=0;
                e<ae.length;
                e++){
                    var n=ae[e];
