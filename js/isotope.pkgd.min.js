    ...
    ,i.filterFindElements=function(t,o){
        ...
        return t.forEach(function(t){
            if(t instanceof HTMLElement){
                ...
                e(t,o)&&n.push(t);
                for(var i=t.querySelectorAll(o),s=0;
                s<i.length;
                s++)n.push(i[s])
            }
        }
...
(window,function(t,e){
    ...
    ,d.layoutPosition=function(){
        ...
        ,i=this.layout._getOption("originLeft"),o=this.layout._getOption("originTop"),n=i?"paddingLeft":"paddingRight",s=i?"left":"right",r=i?"right":"left",a=this.position.x+t[n];
...
(window,function(t,e,i,o,n){
    ...
    ,c._itemize=function(t){
        for(var e=this._filterFindItemElements(t),i=this.constructor.Item,o=[],n=0;
        n<e.length;
        n++){
...
(window,function(t,e){
    ...
    ,o._getItemLayoutPosition=function(t){
        ...
        for(var n=this.options.horizontalOrder?"_getHorizontalColPosition":"_getTopColPosition",s=this[n](o,t),r={
            x:this.columnWidth*s.col,y:s.y
        }
    ...
    ,o._manageStamp=function(t){
        ...
        for(var h=this._getOption("originTop"),d=(h?o.top:o.bottom)+i.outerHeight,l=a;
        l<=u;
...
(window,function(t,e){
    ...
    var i=t.create("masonry"),o=i.prototype,n={
        _getElementOffset:!0,layout:!0,_getMeasurement:!0
    }
    ;
...
(window,function(t,e,i,o,n,s,r){
    ...
    ,l._filter=function(t){
        ...
        return{
            matches:i,needReveal:o,needHide:n
        }
    }
    ...
    ,l._getIsSameSortBy=function(t){
        for(var e=0;
        e<t.length;
        e++)if(t[e]!=this.sortHistory[e])return!1;
        return!0
    }
    ,l._mode=function(){
    ...
    ,l.insert=function(t){
        ...
        if(e.length){
            ...
            for(i=0;
            i<n;
            i++)o=e[i],this.element.appendChild(o.element);
            var s=this._filter(e).matches;
            for(i=0;
            i<n;
            i++)e[i].isLayoutInstant=!0;
            for(this.arrange(),i=0;
            i<n;
            i++)delete e[i].isLayoutInstant;
            this.reveal(s)
        }
    }
    ;
