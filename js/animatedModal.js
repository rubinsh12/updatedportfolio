!function(a){
    a.fn.animatedModal=function(n){
        var t=a(this),o=t.attr("href").replace("#",""),i=a("#"+o).find("[data-modal-close]");
        var e=a.extend({
            modalTarget:o,position:"fixed",width:"100%",height:"100%",top:"0px",left:"0px",zIndexIn:"9999",zIndexOut:"-9999",opacityIn:"1",opacityOut:"0",animatedIn:"fadeIn",animatedOut:"fadeOut",animationDuration:".2s",beforeOpen:function(){
        ...
        ,n),d=a(t).attr("href"),s=a("body").find("#"+e.modalTarget),l="#"+s.attr("id");
        s.addClass("animated"),s.addClass(e.modalTarget+"-off");
        var r={
            position:e.position,width:e.width,height:e.height,top:e.top,left:e.left,"z-index":e.zIndexOut,opacity:e.opacityOut,"-webkit-animation-duration":e.animationDuration,"-moz-animation-duration":e.animationDuration,"-ms-animation-duration":e.animationDuration,"animation-duration":e.animationDuration
        }
        ;
        function m(){
            s.css({
                opacity:e.opacityOut,"z-index":e.zIndexOut
            }
            ),e.afterClose()
        }
        function f(){
        ...
        s.css(r),t.click((function(a){
            a.preventDefault(),d==l&&(s.hasClass(e.modalTarget+"-off")&&(s.removeClass(e.animatedOut),s.removeClass(e.modalTarget+"-off"),s.addClass(e.modalTarget+"-on")),s.hasClass(e.modalTarget+"-on")&&(e.beforeOpen(),s.css({
                opacity:e.opacityIn,"z-index":e.zIndexIn
            }
